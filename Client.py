...
class Client(User):
    ...
    requests_core = ""
    list_of_incoming_messages = []  # list of dictionaries (messages) from users to be verified every ... secs and added to the chat window
    ...
    def clients_server_listen_for_other_users(self):
        ...
        while True:
            ...
            self.list_of_incoming_messages.append(get_frame_from_user(user_socket, self.list_of_all_users, user, self.login))
        ################ Listening for connections #################
